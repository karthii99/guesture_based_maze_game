  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold font-display uppercase tracking-wider ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-neon-cyan to-neon-magenta text-primary-foreground hover:opacity-90 shadow-[0_0_30px_hsl(180_100%_50%/0.5),0_0_60px_hsl(300_100%_60%/0.3)]",
        "hero-outline": "border-2 border-primary/50 bg-background/50 backdrop-blur-sm text-foreground hover:border-primary hover:bg-primary/10",
      },
      size: {
